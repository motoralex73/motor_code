...
internal class MainTest {
    ...
    @Test
    fun `failed solution should return an failed result`() {
        val input = """
          .6..4537.
          ..567342.
          ..4.....1
    ...
    fun `row generator should return coordinates in single row`() {
        val generator = rowCordinateGenerator(rowNumber = 0)
    ...
    fun `column generator should return coordinates in single column`() {
        val generator = colCordinateGenerator(colNumber = 1)
        val generated = listOf(generator(1), generator(0), generator(100))
        assertEquals(listOf(Coordinate(1,1), Coordinate(0,1), Coordinate(100,1)), generated)
    }

    @Test
    fun `quardrant generator should return coordinates in single area`() {
        val generator = quadCordinateGenerator(quadNumber = 0)
